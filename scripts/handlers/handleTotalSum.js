...
// const sumSalePrice = saleCostList.reduce((acc, saleElement) => {
//   const salePrice = +saleElement.textContent.replaceAll(" ", "");
//   return acc + salePrice;
// }, 0);

// // console.log(sumSalePrice);

// totalSaleSumElement.textContent = new Intl.NumberFormat("ru-RU").format(
//   sumSalePrice
// );

// console.log("totalSaleSumElement => ", totalSaleSumElement.textContent);
